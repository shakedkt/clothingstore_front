            ...
            <section className="bag">
                <div className="bag-header">
                    ...
                    <div className="shipping-from">
                        <img src={Flag} alt="" />
                        <h4>Shipping from <span className="country-name"> United Kingdom </span> </h4>
                    </div>
                    <div>
                ...
                <div className="bag-body">
                    ...
                    <img src={crossImage} alt="" className="delete-product" onClick={() => this.deleteFromCart(product.id)}></img>
                </div>
            </section>
        );
    }
